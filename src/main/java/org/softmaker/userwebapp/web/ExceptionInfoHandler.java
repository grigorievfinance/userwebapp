...
import org.softmaker.userwebapp.util.exception.ErrorInfo;
import org.softmaker.userwebapp.util.exception.ErrorType;
import org.softmaker.userwebapp.util.exception.IllegalRequestDataException;
...
import static org.softmaker.userwebapp.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    public static final String EXCEPTION_DUPLICATE_DATETIME = "exception.order.duplicateDateTime";

    private static final Map<String, String> CONSTRAINS_I18N_MAP = Map.of(
            "users_unique_email_idx", EXCEPTION_DUPLICATE_EMAIL,
            "orders_unique_datetime_idx", EXCEPTION_DUPLICATE_DATETIME);
