...
public class OrderTestData {
    ...
    public static TestMatcher<Order> ORDER_MATCHER = TestMatcher.usingFieldsWithIgnoringAssertions(Order.class, "user");
    public static TestMatcher<OrderTo> ORDER_TO_MATCHER = TestMatcher.usingEqualsAssertions(OrderTo.class);

    public static final int NOT_FOUND = 10;
    public static final int ORDER1_ID = START_SEQ + 2;
    public static final int ADMIN_ORDER_ID = START_SEQ + 3;
